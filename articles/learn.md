...
Welcome to the **Learn GPS Sampling manual**. You will find here full
documentation and tutorials for learning to use **GPS Sampling**.
...
Step-by-step tutorials of how to use GPS Sampling, in the form of case
studies. These tutorials are adapted from training materials originally
developed by Epicentre (MSF).
