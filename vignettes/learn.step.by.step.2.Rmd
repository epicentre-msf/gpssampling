...
This method consists in combining the analysis of a satellite image for the identification of building zone, followed by a spatial  sampling. This has been allowed by the `r pkg_infos$title` app.
...
3. **Sample**: From this ensemble, `r pkg_infos$title` can randomly generate a sample of the desired size, and this spatial sample of GPS coordinates can then be exported to a GPS device for field data collection in each of the household living under the sampled building zones
...
2. Click the button **New Sample...** (`r gpssampling:::icon_mdi('map-marker-multiple-outline')`). The dialog box **Sample Settings** opens.
