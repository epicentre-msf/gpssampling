...
5. When all tiles of the polygone have been done : click on the button **Valid All** (`r epi.icons::icon_mdi('checkbox-multiple-marked')`) to validate the pointing of building zones.
...
2. Click the button **New Sample...** (`r epi.icons::icon_mdi('map-marker-radius-outline')`). The map zoom to the random sample point with a radius zone.

    ![](./images/generate_sss_04.webp)

3. Click on the button  **Save** (`r epi.icons::icon_mdi('map-marker-check-outline')`) if you choose to keep the point.
