...
5. When all tiles of the polygone have been done : click on the button **Valid All** (`r gpssampling:::icon_mdi('checkbox-multiple-marked')`) to validate the pointing of roofs.
